...
This contract covers T190 (schema definition), T192 (delta generation), and T193 (delta review). Later M8 tasks handle compact context integration (T194) and relationship-aware eval (T195). This contract must remain stable across those tasks without schema breakage.
